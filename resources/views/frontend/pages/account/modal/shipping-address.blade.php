<!-- Modal -->
<div class="modal fade overflow-auto h-screen" id="shippingAddress" data-backdrop="static" tabindex="-1" role="dialog"
  aria-labelledby="shippingAddressTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="shippingAddressTitle">Add/Update Shipping address</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="{{ route('account.shipping.address') }}" method="POST" id="shipping_address">
          @csrf
          ...
          <div class="form-group">
            <label for="delivery_address" class="col-form-label">Delivery Address: <span
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"
          onclick="document.getElementById('shipping_address').submit()">Save changes</button>
      </div>
    </div>
  </div>
</div>
