    ...
    <section class="welcome_area">
      <div class="welcome_slides owl-carousel">
        @foreach ($banners as $banner)
          <!-- Single Slide -->
          <div class="single_slide bg-img" style="background-image: url({{ asset('storage/' . $banner->photo) }});">
            <div class="container h-100">
              <div class="row h-100 align-items-center">
                <div class="col-7 col-md-8">
                  <div class="welcome_slide_text">
                    <h2 data-animation="fadeInUp" data-delay="300ms">{{ $banner->title }}</h2>
                    <h4 data-animation="fadeInUp" data-delay="600ms">{{ $banner->description }}</h4>
                ...
                <div class="col-5 col-md-4">
                  <div class="welcome_slide_image">
                    <img src="{{ asset('frontend/img/bg-img/slide-1.png') }}" alt="" data-animation="bounceInUp"
                      data-delay="500ms">
                ...
                <div class="single-product-area">
                  <div class="product_image">
                    ...
                    <div class="product_wishlist">
                      ...
                      <a href="wishlist.html" data-product-id="{{ $product->id }}" data-product-qty="1"
                        class="add_to_wishlist" id="add_to_wishlist{{ $product->id }}"><i
                  ...
                  <div class="product_description">
                    ...
                    <div class="product_add_to_cart">
                      <a href="#" data-product-id="{{ $product->id }}" data-product-qty="1"
                        class="add_to_cart" id="add_to_cart{{ $product->id }}"><i class="icofont-shopping-cart"></i>
                        Add to
                        Cart</a>
                    </div>
                    ...
                    <h6 class="product-price">
                      @if ($product->offer_price)
                        {{ $product->offer_price }} <small class="text-danger"><del>{{ $product->price }}</del></small>
                      @else
                        {{ $product->price }}
                      @endif
                    </h6>
      ...
      <div class="row">
        ...
        <div class="col-12 col-lg-6">
          <div class="featured_offer_area d-flex align-items-center"
            style="background-image: url({{ asset('frontend/img/bg-img/fea_offer.jpg') }});">
                ...
                <div class="top_sellers_area">
                  <div class="row">
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/top-1.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                          ...
                          <div class="ts-seller-info mt-3 d-flex align-items-center justify-content-between">
                            ...
                            <div class="ts_product_wishlist">
                              <a href="wishlist.html" data-toggle="tooltip" data-placement="top" title="Wishlist"><i
                                  class="icofont-heart"></i></a>
                            </div>

                            <!-- Compare -->
                            <div class="ts_product_compare">
                              <a href="compare.html" data-toggle="tooltip" data-placement="top" title="Compare"><i
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/top-4.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/top-5.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                          <h5>Sport Shoes</h5>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/top-6.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                          <h5>Pin Up Bikini</h5>
                ...
                <div class="best_rated_area">
                  <div class="row">
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/best-1.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                          <h5>Sports Bra</h5>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/best-2.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/best-3.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                          <h5>Women Watch</h5>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/best-4.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                          <h5>Headphone</h5>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/best-5.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                          <h5>Plus Bra</h5>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                      <div class="single_top_sellers">
                        <div class="top_seller_image">
                          <img src="{{ asset('frontend/img/product-img/best-6.png') }}" alt="Top-Sellers">
                        </div>
                        <div class="top_seller_desc">
                          <h5>Laptop</h5>
