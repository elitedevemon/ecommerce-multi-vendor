<nav class="navbar navbar-fixed-top">
  <div class="container-fluid">
    ...
    <div class="navbar-brand">
      <a href="{{ route('welcome') }}"><img src="{{ asset('backend/assets/images/logo.svg') }}" alt="Lucid Logo"
    ...
    <div class="navbar-right">
      ...
      <div id="navbar-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="app-calendar.html" class="icon-menu d-none d-sm-block d-md-none d-lg-block"><i
          ...
          <li>
            ...
            <a href="{{ route('logout') }}"
              onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="icon-menu">
