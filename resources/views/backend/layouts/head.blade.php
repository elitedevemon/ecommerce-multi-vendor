<title>Advance multi vendor Ecommerce || Dashboard</title>
<meta charset="utf-8">
...
<link rel="stylesheet" href="{{ asset('backend/assets/vendor/fontawesome-free/css/all.min.css') }}">
<!--dropify-->
<link rel="stylesheet" href="{{ asset('backend/assets/vendor/dropify/css/dropify.min.css') }}">
<link rel="stylesheet"
  href="{{ asset('backend/assets/vendor/bootstrap-datepicker/css/bootstrap-datepicker3.min.css') }}">
