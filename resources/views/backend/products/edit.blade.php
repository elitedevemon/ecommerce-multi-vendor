                ...
                <div class="row clearfix">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input id="title" type="text" value="{{ $product->title }}" class="form-control m-0"
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <textarea name="summary" id="summary" class="form-control" placeholder="Summary" rows="5">{{ $product->summary }}</textarea>
                      @error('summary')
                        <small class="font-weight-bold text-danger form-text">{{ $message }}</small>
                      @enderror
                    </div>
                      ...
                      @foreach ($categories as $category)
                        @if ($category->is_parent == '1')
                          <option value="{{ $category->id }}"
                            {{ $product->category_id == $category->id ? 'selected' : '' }}>{{ $category->title }}
                          </option>
                        @endif
                      @endforeach
                    </select>
                    ...
                    <select class="form-control show-tick m-0" id="child_category" name="child_category_id">
                      ...
                      @foreach ($categories as $category)
                        @if ($category->is_parent == '0')
                          <option value="{{ $category->id }}"
                            {{ $product->child_category_id == $category->id ? 'selected' : '' }}>{{ $category->title }}
                          </option>
                        @endif
                      @endforeach
                    </select>
                ...
                <div class="row clearfix mt-3">
                  ...
                  <div class="col-sm-12 col-md-2">
                    <div class="form-group">
                      ...
                      <input id="stock" value="{{ $product->stock }}" type="number" class="form-control m-0"
                  ...
                  <div class="col-sm-12 col-md-2">
                    <div class="form-group">
                      ...
                      <input id="price" value="{{ Number::format(Str::after($product->price, '$')) }}" type="number"
                        class="form-control m-0" placeholder="Price" name="price">
                      @error('price')
                        <small class="font-weight-bold text-danger form-text">{{ $message }}</small>
                      @enderror
                    </div>
                  ...
                  <div class="col-sm-12 col-md-2">
                    <div class="form-group">
                      ...
                      <input id="offer_price"
                        value="{{ $product->offer_price ? Number::format(Str::after($product->offer_price, '$')) : '' }}"
                        type="number" class="form-control m-0" placeholder="Offer Price" name="offer_price">
                      @error('offer_price')
                        <small class="font-weight-bold text-danger form-text">{{ $message }}</small>
                      @enderror
                    </div>
                  ...
                  <div class="col-sm-12 col-md-2">
                    <div class="form-group">
                      ...
                      <input id="discount" value="{{ Str::before($product->discount, '%') }}" type="number"
                        class="form-control m-0" placeholder="Discount" name="discount">
                      @error('discount')
                        <small class="font-weight-bold text-danger form-text">{{ $message }}</small>
                      @enderror
                    </div>
