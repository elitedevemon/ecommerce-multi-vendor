                ...
                <div class="row clearfix">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea id="summary" class="form-control" placeholder="summary" name="summary"></textarea>
                      @error('summary')
                        <small class="font-weight-bold text-danger form-text">{{ $message }}</small>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-6 col-sm-12">
                    ...
                    <input type="checkbox" checked id="is_parent" name="is_parent" value="1" data-toggle="toggle"
                      data-on="Parent" data-off="Child" data-onstyle="success" data-offstyle="danger">
                  </div>

                  <div class="col-md-6 col-sm-12 d-none parent_id">
